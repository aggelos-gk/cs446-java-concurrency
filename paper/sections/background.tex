...
\textbf{Here put a figure: conceptual relationship between the Michael-Scott Queue and the LCRQ.}
...
\textbf{Here put a figure: ticket allocation using Fetch-And-Add.}
...
\textbf{Here put a figure: ring buffer slots used by a Concurrent Ring Queue.}
...
\textbf{Here put a figure: threads distributed across different ring positions.}
...
\textbf{Here put a figure: linking multiple Concurrent Ring Queues.}
