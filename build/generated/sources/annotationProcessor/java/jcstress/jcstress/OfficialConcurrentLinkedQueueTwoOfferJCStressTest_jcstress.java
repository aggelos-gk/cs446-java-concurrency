...
import jcstress.OfficialConcurrentLinkedQueueTwoOfferJCStressTest;
import org.openjdk.jcstress.infra.results.II_Result;

public final class OfficialConcurrentLinkedQueueTwoOfferJCStressTest_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;

    public OfficialConcurrentLinkedQueueTwoOfferJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest t;
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest s;
        II_Result r;

        public JcstressThread_APICheck_actor1(OfficialConcurrentLinkedQueueTwoOfferJCStressTest t, OfficialConcurrentLinkedQueueTwoOfferJCStressTest s, II_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(OfficialConcurrentLinkedQueueTwoOfferJCStressTest t, OfficialConcurrentLinkedQueueTwoOfferJCStressTest s, II_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<II_Result> counter) throws Throwable {
        final OfficialConcurrentLinkedQueueTwoOfferJCStressTest s = new OfficialConcurrentLinkedQueueTwoOfferJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss;
        II_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls, II_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls, II_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls = new OfficialConcurrentLinkedQueueTwoOfferJCStressTest[size];
            II_Result[] lr = new II_Result[size];
            for (int c = 0; c < size; c++) {
                OfficialConcurrentLinkedQueueTwoOfferJCStressTest s = new OfficialConcurrentLinkedQueueTwoOfferJCStressTest();
    ...
    public ArrayList<CounterThread<II_Result>> internalRun() {
        ...
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls = new OfficialConcurrentLinkedQueueTwoOfferJCStressTest[len];
        II_Result[] lr = new II_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new OfficialConcurrentLinkedQueueTwoOfferJCStressTest();
            lr[c] = new II_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<II_Result> cnt, OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls, II_Result[] lr, OfficialConcurrentLinkedQueueTwoOfferJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
            OfficialConcurrentLinkedQueueTwoOfferJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<II_Result> cnt, OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls, II_Result[] lr, OfficialConcurrentLinkedQueueTwoOfferJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<II_Result> {
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss;
        II_Result[] rs;
        OfficialConcurrentLinkedQueueTwoOfferJCStressTest test;

        public JcstressThread_actor1(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss, II_Result[] rs, OfficialConcurrentLinkedQueueTwoOfferJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ls = ss;
            II_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<II_Result> {
        ...
        public JcstressThread_actor2(OfficialConcurrentLinkedQueueTwoOfferJCStressTest[] ss, II_Result[] rs, OfficialConcurrentLinkedQueueTwoOfferJCStressTest test) {
