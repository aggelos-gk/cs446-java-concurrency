...
import jcstress.MSQueueOfferPollJCStressTest;
import org.openjdk.jcstress.infra.results.II_Result;

public final class MSQueueOfferPollJCStressTest_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;

    public MSQueueOfferPollJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        MSQueueOfferPollJCStressTest t;
        MSQueueOfferPollJCStressTest s;
        II_Result r;

        public JcstressThread_APICheck_actor1(MSQueueOfferPollJCStressTest t, MSQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(MSQueueOfferPollJCStressTest t, MSQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<II_Result> counter) throws Throwable {
        final MSQueueOfferPollJCStressTest s = new MSQueueOfferPollJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        MSQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(MSQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(MSQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(MSQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(MSQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2(lr[c]);
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            MSQueueOfferPollJCStressTest[] ls = new MSQueueOfferPollJCStressTest[size];
            II_Result[] lr = new II_Result[size];
            for (int c = 0; c < size; c++) {
                MSQueueOfferPollJCStressTest s = new MSQueueOfferPollJCStressTest();
    ...
    public ArrayList<CounterThread<II_Result>> internalRun() {
        ...
        MSQueueOfferPollJCStressTest[] ls = new MSQueueOfferPollJCStressTest[len];
        II_Result[] lr = new II_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new MSQueueOfferPollJCStressTest();
            lr[c] = new II_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<II_Result> cnt, MSQueueOfferPollJCStressTest[] ls, II_Result[] lr, MSQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
            MSQueueOfferPollJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<II_Result> cnt, MSQueueOfferPollJCStressTest[] ls, II_Result[] lr, MSQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<II_Result> {
        MSQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        MSQueueOfferPollJCStressTest test;

        public JcstressThread_actor1(MSQueueOfferPollJCStressTest[] ss, II_Result[] rs, MSQueueOfferPollJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            MSQueueOfferPollJCStressTest[] ls = ss;
            II_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<II_Result> {
        ...
        public JcstressThread_actor2(MSQueueOfferPollJCStressTest[] ss, II_Result[] rs, MSQueueOfferPollJCStressTest test) {
