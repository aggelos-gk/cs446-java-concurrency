...
import jcstress.OfficialConcurrentLinkedQueueOfferPollJCStressTest;
import org.openjdk.jcstress.infra.results.II_Result;

public final class OfficialConcurrentLinkedQueueOfferPollJCStressTest_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;

    public OfficialConcurrentLinkedQueueOfferPollJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        OfficialConcurrentLinkedQueueOfferPollJCStressTest t;
        OfficialConcurrentLinkedQueueOfferPollJCStressTest s;
        II_Result r;

        public JcstressThread_APICheck_actor1(OfficialConcurrentLinkedQueueOfferPollJCStressTest t, OfficialConcurrentLinkedQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(OfficialConcurrentLinkedQueueOfferPollJCStressTest t, OfficialConcurrentLinkedQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<II_Result> counter) throws Throwable {
        final OfficialConcurrentLinkedQueueOfferPollJCStressTest s = new OfficialConcurrentLinkedQueueOfferPollJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2(lr[c]);
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls = new OfficialConcurrentLinkedQueueOfferPollJCStressTest[size];
            II_Result[] lr = new II_Result[size];
            for (int c = 0; c < size; c++) {
                OfficialConcurrentLinkedQueueOfferPollJCStressTest s = new OfficialConcurrentLinkedQueueOfferPollJCStressTest();
    ...
    public ArrayList<CounterThread<II_Result>> internalRun() {
        ...
        OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls = new OfficialConcurrentLinkedQueueOfferPollJCStressTest[len];
        II_Result[] lr = new II_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new OfficialConcurrentLinkedQueueOfferPollJCStressTest();
            lr[c] = new II_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<II_Result> cnt, OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls, II_Result[] lr, OfficialConcurrentLinkedQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
            OfficialConcurrentLinkedQueueOfferPollJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<II_Result> cnt, OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls, II_Result[] lr, OfficialConcurrentLinkedQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<II_Result> {
        OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        OfficialConcurrentLinkedQueueOfferPollJCStressTest test;

        public JcstressThread_actor1(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss, II_Result[] rs, OfficialConcurrentLinkedQueueOfferPollJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ls = ss;
            II_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<II_Result> {
        ...
        public JcstressThread_actor2(OfficialConcurrentLinkedQueueOfferPollJCStressTest[] ss, II_Result[] rs, OfficialConcurrentLinkedQueueOfferPollJCStressTest test) {
