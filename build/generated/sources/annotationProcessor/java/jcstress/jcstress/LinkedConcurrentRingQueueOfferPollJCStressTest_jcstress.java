...
import jcstress.LinkedConcurrentRingQueueOfferPollJCStressTest;
import org.openjdk.jcstress.infra.results.II_Result;

public final class LinkedConcurrentRingQueueOfferPollJCStressTest_jcstress extends Runner<II_Result> {

    volatile WorkerSync workerSync;

    public LinkedConcurrentRingQueueOfferPollJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        LinkedConcurrentRingQueueOfferPollJCStressTest t;
        LinkedConcurrentRingQueueOfferPollJCStressTest s;
        II_Result r;

        public JcstressThread_APICheck_actor1(LinkedConcurrentRingQueueOfferPollJCStressTest t, LinkedConcurrentRingQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(LinkedConcurrentRingQueueOfferPollJCStressTest t, LinkedConcurrentRingQueueOfferPollJCStressTest s, II_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<II_Result> counter) throws Throwable {
        final LinkedConcurrentRingQueueOfferPollJCStressTest s = new LinkedConcurrentRingQueueOfferPollJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        LinkedConcurrentRingQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(LinkedConcurrentRingQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(LinkedConcurrentRingQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(LinkedConcurrentRingQueueOfferPollJCStressTest[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(LinkedConcurrentRingQueueOfferPollJCStressTest[] ls, II_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2(lr[c]);
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            LinkedConcurrentRingQueueOfferPollJCStressTest[] ls = new LinkedConcurrentRingQueueOfferPollJCStressTest[size];
            II_Result[] lr = new II_Result[size];
            for (int c = 0; c < size; c++) {
                LinkedConcurrentRingQueueOfferPollJCStressTest s = new LinkedConcurrentRingQueueOfferPollJCStressTest();
    ...
    public ArrayList<CounterThread<II_Result>> internalRun() {
        ...
        LinkedConcurrentRingQueueOfferPollJCStressTest[] ls = new LinkedConcurrentRingQueueOfferPollJCStressTest[len];
        II_Result[] lr = new II_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new LinkedConcurrentRingQueueOfferPollJCStressTest();
            lr[c] = new II_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<II_Result> cnt, LinkedConcurrentRingQueueOfferPollJCStressTest[] ls, II_Result[] lr, LinkedConcurrentRingQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
            LinkedConcurrentRingQueueOfferPollJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<II_Result> cnt, LinkedConcurrentRingQueueOfferPollJCStressTest[] ls, II_Result[] lr, LinkedConcurrentRingQueueOfferPollJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<II_Result> {
        LinkedConcurrentRingQueueOfferPollJCStressTest[] ss;
        II_Result[] rs;
        LinkedConcurrentRingQueueOfferPollJCStressTest test;

        public JcstressThread_actor1(LinkedConcurrentRingQueueOfferPollJCStressTest[] ss, II_Result[] rs, LinkedConcurrentRingQueueOfferPollJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            LinkedConcurrentRingQueueOfferPollJCStressTest[] ls = ss;
            II_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<II_Result> {
        ...
        public JcstressThread_actor2(LinkedConcurrentRingQueueOfferPollJCStressTest[] ss, II_Result[] rs, LinkedConcurrentRingQueueOfferPollJCStressTest test) {
